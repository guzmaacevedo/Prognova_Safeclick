...
public class BancoPreguntas {
    ...
    private void cargarPreguntas() {
        ...
        preguntas.add(new Pregunta(
                "Recibes un mensaje de texto de 'tu banco' diciendo que tu cuenta será bloqueada si no confirmas tus datos."
                + "\nTen precaución y decide bien:",
                new String[]{
                    "Abrir el mensaje y confirmar datos",
                    "Envía solo tu documento de identidad",
                    "Preguntar algun amigo si también recibió ese mensaje y hacer lo mismo que el",
                    "Contactar al banco en sus canales oficiales"
                },
                3
        ));

        preguntas.add(new Pregunta(
                "Tu antivirus detecta un archivo sospechoso."
                + "\nVeamos que tan confiado eres:",
                new String[]{
                    "Abrirlo y ver si en verdad es peligroso",
                    "Cerrar la advertencia del antivirus",
                    "Enviarlo a cuarentena para revisión profunda o eliminarlo",
                    "Desactivar antivirus para abrirlo"
                },
                2  
        ));
    }
